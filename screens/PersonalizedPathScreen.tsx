        ...
        const generateContent = async () => {
            ...
            try {
                ...
                if (type.startsWith('ACADEMIC')) {
                    ...
                    const module = await getChapterContent(student.grade, details.subject, details.chapter, language);
                    ...
                    const module = await getChapterContent(student.grade, weakArea.subject, weakArea.chapter, language);
    ...
    return (
        <div className="animate-fade-in">
             <div className="mb-6 p-6 bg-white dark:bg-slate-800 rounded-2xl shadow-lg">
                ...
                <h1 className="text-3xl font-bold text-slate-800 dark:text-slate-100">{t('todaysTask')}</h1>
