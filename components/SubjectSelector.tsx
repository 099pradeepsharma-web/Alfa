      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          {selectedSubject && onChapterSelect ? (
                ...
                {selectedSubject.chapters.map((chapter) => (
                   <li key={chapter.title}>
                    <button
                      ...
                      className="w-full text-left p-4 rounded-lg flex items-center justify-between transition-all duration-200 bg-slate-50 dark:bg-slate-700 hover:bg-primary-light hover:shadow-sm dark:hover:bg-slate-600"
                    >
            ...
            <div className="flex items-center justify-center h-full bg-slate-100 dark:bg-slate-800 rounded-xl p-8">
